...
function addObject(type) {
    ...
    console.log("Objets dans la scène :", objects);
}
...
function onDoubleClick(event) {
    ...
    if (intersects.length > 0) {
        ...
        // Remonter dans la hiérarchie des objets pour trouver l'objet parent avec isMovable
        ...
        if (parentObject && parentObject.userData.isMovable) {
            ...
            console.log("Aucun objet parent déplaçable trouvé");
        }
    } else {
